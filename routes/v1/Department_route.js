...
router.get('/stats', auth, async (req, res) => {
    try {
          ...
          },
          {
            $avg: {
              $map: {
                ...
                in: {
                  $divide: [
                    { $subtract: ["$$completedTask.updatedAt", "$$completedTask.createdAt"] },
                    1000 * 60 * 60 * 24// convert ms → hours
                  ]
                }
              }
            }
      ...
      if(stats){
          ...
          console.log("stats from departments",stats)
        }
